...
MAX_SPREAD_PCT = UNLOCKED_MAX_SPREAD_ABSOLUTE
...
# duplicate removed: A_PLUS_MIN_CONFIDENCE = 0.42
# duplicate removed: A_PLUS_MIN_QUALITY = 0.012
# duplicate removed: A_PLUS_MAX_SPREAD = 0.020
