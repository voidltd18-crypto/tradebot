...
def calculate_new_position_notional():
    # Do not show or use a buy size when the bot is already at/above the
    # configured max-position limit. This fixes the tiny £0.01/£1.13 display
    # caused by sizing while allowed_new_position_count() is zero.
...
def _compat_buy_preview():
    ...
    # If no new positions are allowed, both previews must show zero.
    # This avoids misleading penny-sized estimates when maxPositions < openPositions.
