...
for the execution subsystem and deliberately contains no duplicated runtime logic.
"""
from .registry import SERVICE_REGISTRY

DESCRIPTOR = next(item for item in SERVICE_REGISTRY if item.key == "execution")
